    ...
    },
    {
      ...
      render: function (data, type, row, meta) {
        ...
        if (type === "display") {
          ...
          data += '<a href="../Amendment/viewpsdetails/' + row.encrypakaun + '" class="btn btn-primary btn-alt btn-xs"><i class="fa fa-eye"></i> Lihat</a>'
          data += "</div>"
        }
...
$("#form-verifylists").on("submit", function (e) {
  ...
  var form = this
  var rows_selected = submitsitereview.column(0).checkboxes.selected()
  var submit_id = $("#submitId").val()
  // console.log(form.)
...
$("#submitsitereview").css("font-size", 10)
