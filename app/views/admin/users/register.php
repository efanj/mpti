          ...
          <div class="panel panel-default">
            <div class="panel-heading bg-primary">
              <div class="row align-items-center">
                <div class="col">
                  <h4 class="ml15">Daftar Pengguna</h4>
                </div>
                <!--end col-->
                <div class="col-auto">
                  <button class="btn btn-primary btn-sm mt5 mr15" onclick="history.back();">KEMBALI</button>
                </div>
                <!--end col-->
              </div>
            </div>
              ...
              <form action="<?php echo PUBLIC_ROOT; ?>Login/register" id="form-register" method="post"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="email" name="email" class="form-control input-sm" maxlength="64" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input dir="auto" type="text" name="name" class="form-control input-sm" minlength="5"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control input-sm" name="workplace">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <?php
                                                ...
                                                ?>
                      <label>Jawatan</label>
                      <select name="position" class="form-control input-sm" size="1">
                        <option value="">Sila Pilih</option>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input dir="auto" type="text" name="worker_id" class="form-control form-control-sm" maxlength="50"
                        required>
                      <small class="form-text text-muted">* Wajib</small>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input autocomplete="new-password" type="password" name="password" id="password"
                        class="form-control form-control-sm" minlength="6" required>
                      <div class="password-show-hide"><span class="show"> </span></div>
                      <small class="form-text text-muted">Passwords must contain at least one uppercase, lowercase and
                        number</small>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input autocomplete="new-password" type="password" name="confirm_password" id="confirm_password"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <table width="100%">
                      <tr>
                        <th colspan="2" class="p-b-10"><input type="text" class="form-control form-control-sm"
                            placeholder="Create password" id="passwordBox" readonly></th>
                      </tr>
                      <tr>
                        <th class="text-start">
                          <div id="button" class="btn btn-primary btn-xs" onclick="password_generator()">Generate</div>
                        </th>
                        <th class="text-end"><a id="button" class="btn btn-default btn-xs"
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="activate" class="form-control input-sm" required>
                        <option value="">Sila Pilih</option>
