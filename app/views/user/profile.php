                  ...
                  <form action="<?php echo PUBLIC_ROOT; ?>User/updateProfileInfo" id="form-profile-info" method="post">
                    <div class="form-group">
                      <div class="block-section text-center">
                        <img src="<?= $info["image"]; ?>" class="img-circle profile-pic-lg" width="200" height="200">
                    ...
                    <div class="form-group">
                      ...
                      <input dir="auto" type="text" name="name" value="<?= $info["name"]; ?>"
                        class="form-control form-control-sm" required maxlength="30" placeholder="Your Name..">
                      <small class="form-text text-danger">The maximum number of characters allowed is
                        <strong>30</strong></small>
                    </div>
                    <div class="form-group">
                      <label class="form-label">Jawatan</label>
                      <input dir="auto" type="text" name="position" value="<?= $info["position"]; ?>"
                    ...
                    <div class="form-group">
                      ...
                      <small class="form-text text-muted text-danger">Passwords must contain at least one uppercase, one
                        lowercase, one number, and not less than 6 characters</small>
                    </div>
                    <div class="row mt10 ml10 mb10">
                      <div class="col-md-6">
                        <table width="100%">
                          <tr>
                            <td colspan="2" class="p-b-10"><input type="text" class="form-control form-control-sm"
                                placeholder="Create password" id="passwordBox" readonly></td>
                          </tr>
                          <tr class="pt10">
                            <td class="text-start pt10">
                              <div id="button" class="btn btn-primary btn-xs" onclick="password_generator()">Generate
                              </div>
                            </td>
                            <td class="text-end pt10"><a id="button" class="btn btn-info btn-alt btn-xs"
                                onclick="copyPassword()">Copy</a></td>
                          </tr>
                        </table>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <input type="email" name="email" value="<?= $this->encodeHTML($info["email"]); ?>"
                        class="form-control form-control-sm" maxlength="50" placeholder="Your Email..">
                    </div>
                    <div class="form-group">
                      <input type="email" name="confirm_email" value="" class="form-control form-control-sm"
                        maxlength="50" placeholder="Confirm Email">
                      <small class="form-text text-muted text-danger">Please enter your email again.</small>
                    </div>
                    <div class="form-group">
