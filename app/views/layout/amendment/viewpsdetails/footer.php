...
<script src="<?= PUBLIC_ROOT ?>plugins/forms/fancyselect/fancySelect.js"></script>
<script src="<?= PUBLIC_ROOT ?>plugins/forms/select2/select2.js"></script>
<script src="<?= PUBLIC_ROOT ?>plugins/ui/lightbox/ekko-lightbox.js"></script>
<script src="<?= PUBLIC_ROOT ?>plugins/forms/modal-pdf/modal-pdf.js"></script>
...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard/wizard-review.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/mapview_review.js" type="text/javascript"></script>
