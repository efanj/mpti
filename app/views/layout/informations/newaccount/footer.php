...
<script src="<?= PUBLIC_ROOT ?>js/pages/new-account.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/newaccount-map.js" type="text/javascript"></script>
