    ...
    <div class="page-content-inner">
      ...
      <div class="row">
        <div class="col-lg-8 col-sm-8 col-md-8">
          <?php $smk = $this->controller->Informations->getReviewAcctInfo($fileId); ?>
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h4>NILAIAN SEMULA PEGANGAN</h4>
            </div>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab1">
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-4 control-label tal">
                          <?= $smk["smk_akaun"] ?>
                          <input type="hidden" name="id" value="<?= $smk["sid"] ?>" />
                          <input type="hidden" name="Akaun" value="<?= $smk["smk_akaun"] ?>" />
                          <input type="hidden" name="Digit" value="<?= $smk["peg_digit"] ?>" />
                        </div>
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-4 control-label tal"><?= $smk["peg_oldac"] ?></div>
                        <div class="col-md-2"></div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1">
                          <div class="checkbox-custom">
                            <input type="checkbox" id="dummy_mjb_Stcbk" <?php if ($smk["peg_stcbk"] === "Y") {
                                                                          echo "checked";
                                                                        } ?>disabled>
                            <label for="dummy_mjb_Stcbk"></label>
                          </div>
                          <input type="hidden" id="mjb_stcbk" name="Stcbk" value="<?= $smk["peg_stcbk"] ?>">
                        </div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10 control-label tal"><?= $smk["pmk_nmbil"] ?></div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                          <label class="control-label">No. lot :</label>
                        </div>
                        <div class="col-md-4 control-label tal"><?= $smk["peg_nolot"] ?></div>
                        <div class="col-md-2">
                          <label class="control-label">Jalan :</label>
                        </div>
                        <div class="col-md-4 control-label tal"><?= $smk["jln_jnama"] ?></div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                          <label class="control-label">Alamat :</label>
                        </div>
                        <div class="col-md-4 control-label tal"><?= $smk["adpg1"] ?></div>
                        <div class="col-md-2">
                          <label class="control-label">Kawasan :</label>
                        </div>
                        <div class="col-md-4 control-label tal">
                          <?= $smk["jln_knama"] ?>
                          <input type="hidden" value="<?= $smk["kaw_kwkod"] ?>" name="kawKwkod" id="kawKwkod">
                        </div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4 control-label tal"><?= $smk["adpg2"] ?></div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                          <label class="control-label"></label>
                        </div>
                        <div class="col-md-4 control-label tal"><?= $smk["adpg3"] ?></div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                          <label class="control-label"></label>
                        </div>
                        <div class="col-md-4 control-label tal"><?= $smk["adpg4"] ?></div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                          ...
                          <select class="form-control input-sm" name="Thkod">
                            <option selected>Sila Pilih</option>
                            <?php foreach ($htanah as $row) { ?>
                              <option <?php if ($row["tnh_thkod"] == $smk["thkod"]) {
                                        echo "selected";
                        ...
                        <div class="col-md-4">
                          ...
                          <select class="form-control input-sm" name="Bgkod">
                            <option selected>Sila Pilih</option>
                            <?php foreach ($hbangn as $row) { ?>
                              <option <?php if ($row["bgn_bgkod"] == $smk["bgkod"]) {
                                        echo "selected";
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-4">
                          ...
                          <select class="form-control input-sm" id="mjb_htkod" name="Htkod">
                            <option selected>Sila Pilih</option>
                            <?php foreach ($hharta as $row) { ?>
                              <option <?php if ($row["hrt_htkod"] == $smk["htkod"]) {
                                        echo "selected";
                        ...
                        <div class="col-md-4">
                          ...
                          <select class="form-control input-sm" name="Stkod">
                            <option selected>Sila Pilih</option>
                            <?php foreach ($hstbgn as $row) { ?>
                              <option <?php if ($row["stb_stkod"] == $smk["stkod"]) {
                                        echo "selected";
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-4 control-label tal">
                          <?= $smk["jpk_jnama"] ?>
                          <input type="hidden" name="Jpkod" value="<?= $smk["peg_jpkod"] ?>">
                        </div>
                      </div>
                      <div class="row mb15">
                        <div class="col-md-2">
                    ...
                    <div class="tab-pane" id="tab2">
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-2 control-label tal"><?= $smk["peg_nompt"] ?></div>
                        <div class="col-md-2">
                          <label class="control-label">Rujukan Fail :</label>
                        </div>
                        <div class="col-md-2 control-label tal"><?= $smk["peg_rjfil"] ?></div>
                        <div class="col-md-2">
                          <label class="control-label">No. Pelan :</label>
                        </div>
                        <div class="col-md-2 control-label tal"><?= $smk["peg_pelan"] ?></div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2 control-label tal"><?= $smk["peg_bilpk"] ?></div>
                        <div class="col-md-2">
                          <label class="control-label">Rujukan MMK :</label>
                        </div>
                        <div class="col-md-2 control-label tal"><?= $smk["peg_rjmmk"] ?></div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                          <label class="control-label">Luas Bangunan :</label>
                        </div>
                        <div class="col-md-2 control-label tal"><?= $smk["peg_lsbgn"] ?> m&sup2;</div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2 control-label tal"><?= $smk["peg_lstnh"] ?> m&sup2;</div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
                          <label class="control-label">Luas Ansolari :</label>
                        </div>
                        <div class="col-md-2 control-label tal"><?= $smk["peg_lsans"] ?> m&sup2;</div>
                        <div class="col-md-2">
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-6">
                          <div class="input-group input-group-sm">
                            <input type="hidden" id="sbkod" name="Sbkod">
                            <input type="text" class="form-control input-sm" id="dummy_sbkod">
                            <span class="input-group-btn">
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-10">
                          <input class="form-control input-sm" type="text" name="Mesej">
                        </div>
                      </div>
