          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              <div class="row align-items-center">
                <div class="col">
                  <h4 class="ml15">NILAIAN - BANGUNAN</h4>
                </div>
                <!--end col-->
                <div class="col-auto">
                  <button class="btn btn-default btn-sm mt5 mr15" id="print" data-sirino="<?= $info["esirino"] ?>"><i
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><input type="number" class="form-control input-sm" name="breadth_land" id="breadth_land"
                                min="0" value="<?= $info['land']["breadth"] ?>"></td>
                            <td>mp</td>
                            <td style="text-align:center">X</td>
                            <td><input type="number" class="form-control input-sm" name="price_land" id="price_land"
                                min="0" value="<?= $info['land']["price"] ?>"></td>
                            <td>smp</td>
                            <td><input type="number" class="form-control input-sm ttl_partly" id="total_land"
                                value="<?= $info['land']["total"] ?>" readonly>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <section id="<?= $section['id'] ?>">
                          <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-9">
                              <input type="hidden" name="section_one[<?= $section['id'] ?>][id]"
                                value="<?= $section['id'] ?>">
                              <input type="text" class="form-control input-sm"
                                name="section_one[<?= $section['id'] ?>][main_title]" value="<?= $section['title'] ?>">
                            </div>
                          </div>
                          ...
                          <table class="table table-bordered one" id="zero" style="font-size:13px;">
                            ...
                            <tbody id="zero">
                              ...
                              <tr id="<?= $row['id'] ?>">
                                <td>
                                  <input type="hidden"
                                    name="section_one[<?= $section['id'] ?>][item][<?= $row['id'] ?>][id]"
                                    value="<?= $row['id'] ?>">
                                  <input type="text" class="form-control input-sm"
                                    name="section_one[<?= $section['id'] ?>][item][<?= $row['id'] ?>][title_one]"
                                    value="<?= $row['title'] ?>">
                                </td>
                                <td><input type="number" class="form-control input-sm"
                                    name="section_one[<?= $section['id'] ?>][item][<?= $row['id'] ?>][breadth_one]"
                                    id="breadth_one" min="0" value="<?= $row["breadth"] ?>"></td>
                                <td>
                                  <select class="form-control input-sm"
                                    name="section_one[<?= $section['id'] ?>][item][<?= $row['id'] ?>][breadthtype_one]">
                                ...
                                <td style="text-align:center">X</td>
                                <td><input type="number" class="form-control input-sm"
                                    name="section_one[<?= $section['id'] ?>][item][<?= $row['id'] ?>][price_one]"
                                    id="price_one" min="0" value="<?= $row['price'] ?>"></td>
                                <td>
                                  <select class="form-control input-sm"
                                    name="section_one[<?= $section['id'] ?>][item][<?= $row['id'] ?>][pricetype_one]">
                                    <option value="">Sila Pilih</option>
                                ...
                                <td><input type="number" class="form-control input-sm"
                                    name="section_one[<?= $section['id'] ?>][item][<?= $row['id'] ?>][total_one]"
                                    id="total_one" value="<?= $row['total'] ?>" readonly></td>
                                <td></td>
                              </tr>
                              <?php } ?>
                            </tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <strong>RM</strong> <span class="control-label tal bold"
                              id="dummy_tax"><?= $info["assessment_tax"] ?></span>
                          </td>
                        </tr>
                      </table>
                    </div>
