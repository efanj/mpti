<div class="page-content sidebar-page clearfix">
  ...
  <div class="page-content-wrapper">
    <div class="page-content-inner">
      <!-- Start .row -->
      <?php $info = $this->controller->informations->getSubmitionVendorInfo($siriNo); ?>
      <?php $acct = $this->controller->informations->getAcctInfo($info['acctno']); ?>
      <div class="row">
        <div class="col-lg-4 col-sm-4 col-md-4">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <input type="hidden" id="kwkod" value="<?= $info["jlkod"]; ?>">
              ...
              <table class="info" style="width:100%;font-size:13px;">
                <tr>
                  ...
                  <td style="width:2%">:</td>
                  <td style="width:15%"><?= $info["acctno"] ?></td>
            ...
            <div class="panel-body">
              <div id="calc-building" class="bwizard">
                ...
                <form class="form-horizontal" role="form" id="calcBuilding" method="post">
                  <input type="hidden" name="siri_no" value="<?= $info["sirino"] ?>">
                  <input type="hidden" name="akaun" value="<?= $info["acctno"] ?>">
                    ...
                    <div class=" tab-pane active" id="tab1">
                      ...
                      <table class="table table-bordered land">
                        ...
                        <tbody>
                          <tr>
                            <td></td>
                            <td><input type="number" class="form-control input-sm" name="breadth_land" id="breadth_land" value="<?= $acct["peg_lstnh"] ?>"></td>
                            <td>mp</td>
                          ...
                          <table class="table table-bordered one" id="zero" style="font-size:13px;">
                            ...
                            <tbody id="zero">
                              <tr id="0">
                                ...
                                <td><input type="number" class="form-control input-sm" name="section_one[0][item][0][breadth_one]" id="breadth_one" value="<?= $acct["peg_lsbgn"] ?>"></td>
                                <td>
                          ...
                          <table class="table table-bordered two" id="zero" style="font-size:13px;">
                            ...
                            <tbody id="zero">
                              <tr id="0">
                                ...
                                <td><input type="number" class="form-control input-sm" name="section_two[0][item][0][breadth_two]" id="breadth_two" value="<?= $acct["peg_lsans"] ?>"></td>
                                <td>
